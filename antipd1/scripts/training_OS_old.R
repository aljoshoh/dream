...
save(data, file  = "metadata/train_data_OS.RData")
...
# Save training
save(glrn, file = paste0(getwd(),"/models/",model_id,"/","untuned_OS.RData"))
save(autotune, file = paste0(getwd(),"/models/",model_id,"/","tuned_OS.RData"))
###############################################
