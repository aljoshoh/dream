...
modelsa <- get_features("outputs/mut-surv/cox_default_cv.RData", matrixfy = F)
modelsb <- get_features("outputs/rna-surv/cox_default_cv.RData", matrixfy = F)
modelsc <- get_features("outputs/clin-surv/cox_default_cv.RData", matrixfy = F)
modelsd <- get_features("outputs/auc-surv/cox_default_cv.RData", matrixfy = F)
...
descriptor <- "cox" # the descriptor does not care here
####################
